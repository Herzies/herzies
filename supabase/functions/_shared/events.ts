/**
 * Vendored copy of `packages/web/src/lib/events.ts` for the Edge Function.
 * See `./game-server.ts` for why this needs to be a copy rather than an
 * import, and the production path for removing the duplication.
 */
import type { SupabaseClient } from "@supabase/supabase-js";
import type { SongHuntConfig, SongHuntFinder } from "./herzies-shared.ts";
